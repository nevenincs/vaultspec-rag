...
Auto-generated index of all documents tagged with `#mcp-project-root-contract`.
...
- `2026-07-25-mcp-project-root-contract-plan` - `mcp-project-root-contract` plan

### research

- `2026-07-25-mcp-project-root-contract-research` - `mcp-project-root-contract` research: `which side of the project-root contract is wrong`

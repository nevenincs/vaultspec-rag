...
# `mcp-launch-hygiene` feature index

Auto-generated index of all documents tagged with `#mcp-launch-hygiene`.

## Documents

### adr

- `2026-07-17-mcp-launch-hygiene-adr` - `mcp-launch-hygiene` adr: `rag binds to core's static-launch contract: tool spec token and placement-aware extra` | (**status:** `accepted`)

### audit

- `2026-07-17-mcp-launch-hygiene-audit` - `mcp-launch-hygiene` audit: `review of the issue-231 launch-hygiene fixes`
...
- `2026-07-17-mcp-launch-hygiene-plan` - `mcp-launch-hygiene` plan

### research

- `2026-07-17-mcp-launch-hygiene-research` - `mcp-launch-hygiene` research: `binding rag to core's static-launch MCP contract`

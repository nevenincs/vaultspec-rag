...
- [x] `S03` - Run the read operations (count, scroll, retrieve) under the bounded retry; `src/vaultspec_rag/store.py`.
- [x] `S04` - Run the point-delete operations under the bounded retry; `src/vaultspec_rag/store.py`.

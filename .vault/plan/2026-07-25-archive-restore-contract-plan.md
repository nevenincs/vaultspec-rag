...
- [ ] `P01.S05` - Cover the whole-archive sweep and the integrity gate with guard tests, and prove each fails when its check is removed; `src/vaultspec_rag/tests/test_storage_ops.py`.

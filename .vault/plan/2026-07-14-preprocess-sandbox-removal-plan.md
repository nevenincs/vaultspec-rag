...
- [ ] `P03.S18` - Update operator docs to the trust-based framing that preprocess config is code execution with operator privileges, removing sandbox/unsandboxed knob references; `docs/preprocessing-hooks.md`.
- [ ] `P03.S19` - Sweep remaining sandbox mentions from README, cli, and configuration docs; `docs/`.

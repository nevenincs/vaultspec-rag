...
tier: L2
related:
  - "[[2026-07-25-qdrant-store-format-conformance-adr]]"
---

<!-- FRONTMATTER RULES:
     tags: one directory tag (hardcoded #plan) and one feature tag.
     Replace qdrant-store-format-conformance with a kebab-case feature tag, e.g. #foo-bar.
...
# `qdrant-store-format-conformance` plan

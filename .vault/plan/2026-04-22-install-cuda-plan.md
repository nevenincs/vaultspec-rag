...
Retained-plan evidence: the summary and prerequisites sections state this plan's scope and preconditions.

## Steps

Retained-plan evidence: step 1 through step 10 are this plan's execution inventory.
...
Retained-plan evidence: step 9 names the full test and lint sweep; no separate verification result is asserted.

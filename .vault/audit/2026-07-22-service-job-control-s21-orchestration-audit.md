...
<!-- A rolling log of findings: append one subsection per finding, grouped or ordered by
     severity, using the heading form
       ...
       ### W03.P11.S21 watcher orchestration verification | {level} | {summary}

     followed by a paragraph carrying the detail. W03.P11.S21 watcher orchestration verification is a concise kebab-case slug,

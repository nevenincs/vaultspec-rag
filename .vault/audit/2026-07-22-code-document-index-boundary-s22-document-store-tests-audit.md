...
<!-- A rolling log of findings: append one subsection per finding, grouped or ordered by
     severity, using the heading form
       ...
       ### S22 real document store verification | {level} | {summary}

     followed by a paragraph carrying the detail. S22 real document store verification is a concise kebab-case slug,

...
- Require every captured borrower mint and post-lease revalidation API to take only the typed witness or pointer evidence; raw paths are nonsecret diagnostics in the frozen target, never authority-bearing inputs.

...
<!-- A rolling log of findings: append one subsection per finding, grouped or ordered by
     severity, using the heading form
       ...
       ### S20 lifecycle restore and shutdown | {level} | {summary}

     followed by a paragraph carrying the detail. S20 lifecycle restore and shutdown is a concise kebab-case slug,

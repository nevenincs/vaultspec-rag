...
<!-- FRONTMATTER RULES:
     ...
     The S90 and 2026-07-22-code-document-index-boundary-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Thread the exact resolved snapshot through worker execution, epochs, ledger signatures, and metadata publication without a second configuration load and ## Scope

...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-07-22-code-document-index-boundary-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Make CLI dry-run apply the same preprocessing mode and return the structured admission summary and ## Scope

- `src/vaultspec_rag/cli/_index.py` placeholders below are machine-filled

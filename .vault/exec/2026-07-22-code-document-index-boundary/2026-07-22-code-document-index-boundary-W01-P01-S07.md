...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-22-code-document-index-boundary-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify real configuration loading, route ordering, one-owner enforcement, and mutation-free migration refusal and ## Scope

- `src/vaultspec_rag/tests/test_content_policy.py`
- `src/vaultspec_rag/tests/test_preprocess_config.py` placeholders below are machine-filled

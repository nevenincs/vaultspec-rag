...
<!-- FRONTMATTER RULES:
     ...
     The S91 and 2026-07-22-code-document-index-boundary-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify an on-disk configuration edit during real extraction cannot change the active operation fingerprint or publication identity and ## Scope

- `src/vaultspec_rag/tests/integration/test_policy_snapshot.py` placeholders below are machine-filled

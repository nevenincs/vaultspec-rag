...
<!-- FRONTMATTER RULES:
     ...
     The S106 and 2026-07-22-code-document-index-boundary-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Render targets, extractor versions, path-independence, schema migration, and disabled execution through preprocess list, check, and status and ## Scope

- `src/vaultspec_rag/cli/_preprocess.py` placeholders below are machine-filled

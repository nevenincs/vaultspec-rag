...
<!-- FRONTMATTER RULES:
     ...
     The S22 and 2026-07-22-code-document-index-boundary-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify document identities, schema, locks, and lifecycle against real local and server Qdrant stores and ## Scope

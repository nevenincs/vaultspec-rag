...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-07-22-service-health-client-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Assert a redirect answered on a token-carrying request path is refused and the bearer credential never reaches the redirect target and ## Scope

...
<!-- FRONTMATTER RULES:
     ...
     The S01 and 2026-07-22-service-health-client-hardening-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Build the transport's requests through a redirect-refusing opener so no request path follows a 3xx and ## Scope

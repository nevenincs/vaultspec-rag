...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-07-13-control-plane-affordances-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Cover the root-scoped lookup end to end: indexed root returns prefix plus populated namespaces, unindexed root returns prefix plus empty list, and the CLI and MCP adapters pass the parameter through and ## Scope

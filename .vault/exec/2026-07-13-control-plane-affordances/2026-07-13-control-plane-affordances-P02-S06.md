...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-07-13-control-plane-affordances-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Assert the stop --json envelope and exit code on each exit path alongside the existing start --json matrix and ## Scope

- `src/vaultspec_rag/tests/integration` placeholders below are machine-filled

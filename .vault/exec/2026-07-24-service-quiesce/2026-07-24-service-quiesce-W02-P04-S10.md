...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-07-24-service-quiesce-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Create the serialized resource-quiesce controller with state transitions, epoch-scoped compute tickets, bounded drain acknowledgement and truthful safety snapshots and ## Scope

- `src/vaultspec_rag/service_quiesce.py` placeholders below are machine-filled

...
<!-- FRONTMATTER RULES:
     ...
     The S02 and 2026-07-21-managed-log-contract-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Install the service log handler from the generic managed-log settings and ## Scope

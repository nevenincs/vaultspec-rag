...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-07-21-managed-log-contract-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Document generic managed-log environment variables and aggregate retention semantics and ## Scope

- `docs/configuration.md` placeholders below are machine-filled

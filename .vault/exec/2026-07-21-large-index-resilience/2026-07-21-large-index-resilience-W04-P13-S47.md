...
<!-- FRONTMATTER RULES:
     ...
     The S47 and 2026-07-21-large-index-resilience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Complete the 250872-chunk incident floor on the declared default managed-service profile and ## Scope

- `src/vaultspec_rag/tests/benchmarks/bench_large_index_resilience.py` placeholders below are machine-filled

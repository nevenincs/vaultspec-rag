...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-25-index-resume-drift-race-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Give the indexed-path upsert collision its own exception type so a racing path is distinguishable from a genuine invariant breach and ## Scope

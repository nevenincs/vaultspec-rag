...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-07-25-index-resume-drift-race-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extract drift ownership into its own collaborator that holds the drop-points-then-remove-units ordering as a property of the type and ## Scope

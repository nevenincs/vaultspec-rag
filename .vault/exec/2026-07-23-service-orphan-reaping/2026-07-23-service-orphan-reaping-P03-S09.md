...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-07-23-service-orphan-reaping-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a test that the reap clears a real lingering launcher-daemon orphan pair and ## Scope

- `src/vaultspec_rag/tests/integration/test_qdrant_orphan_reap.py` placeholders below are machine-filled

...
<!-- FRONTMATTER RULES:
     ...
     The S19 and 2026-07-21-service-job-control-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Keep watcher enablement separate from job cancellation and wait for manager-owned cleanup on watcher stop using vaultspec-high-executor and ## Scope

- `src/vaultspec_rag/server/_watcher.py` placeholders below are machine-filled

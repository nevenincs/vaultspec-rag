...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-07-21-service-job-control-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Verify paused attempts release limiter, lease, writer ownership, thread, and pipeline resources and cancelled attempts make no later writes using vaultspec-high-executor and ## Scope

...
description: Ground a decision in evidence before it is made. Use when an ADR is warranted
  and the options have not been weighed on evidence already in the vault or the code.
---

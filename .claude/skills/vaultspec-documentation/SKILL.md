...
description: Create or substantially rewrite one user-facing README, guide, or feature
  document. Focused maintenance edits use a direct evidence-and-review pass.
---

...
name (``tools.binaries.build_pyapp``), which is what lets the cohabiting
:mod:`tools.binaries.tests` package exercise it the way every other tree in this
repository tests its own code.

Modules:
    :mod:`tools.binaries.build_pyapp`: Release binary builder driven by PyApp.
"""
